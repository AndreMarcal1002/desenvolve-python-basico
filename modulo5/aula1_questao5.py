""" 5) Você está trabalhando em um sistema de mensagens instantâneas, que deve permitir o uso de emojis 
...
A seguir um exemplo de interação, com uma lista de emojis sugeridos. Você pode consultar o texto 
que codifica outros emojis indo nessa página e passando o mouse por cima do emoji desejado. 
Emojis disponíveis:
❤️- :red_heart:
👍 - :thumbs_up:
🤔 - :thinking_face:
...
Olá mundo! :red_heart:
Frase emojizada:
Olá mundo!  HYPERLINK "https://emojipedia.org/red-heart"❤️   
