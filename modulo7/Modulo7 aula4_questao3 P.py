""" 3) Baixe o arquivo contendo o roteiro do filme brasileiro 
"Estômago" (link a seguir) e salve em seu computador 
com o nome "estomago.txt". 

Link: https://aplauso.imprensaoficial.com.br/edicoes/12.0.813.502/12.0.813.502.txt

Em seguida crie um script em Python que abra o arquivo para 
leitura e imprima: 
